...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			...
			if ( '1' === $wordpress_bootstrap_starter_theme_comment_count ) {
				...
				printf( 
					...
					number_format_i18n( $wordpress_bootstrap_starter_theme_comment_count ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					'<span>' . wp_kses_post( get_the_title() ) . '</span>'
				);
			}
			?>
		...
		if ( ! comments_open() ) :
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'wordpress-bootstrap-starter-theme' ); ?></p>
			<?php
		endif;
